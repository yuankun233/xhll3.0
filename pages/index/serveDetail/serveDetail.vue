	...
	<view class="container">
		...
		<view class="selectServeMessage">
			<view class="serve_patient item" @click="patientSelect">
				...
				<input type="text" v-model="form.archiveName" class="input" placeholder="请选择信息"
					:placeholder-style="placeholder" :disabled="disabled" />
			</view>
			<view class="serve_patient item" @click="picker.date = true">
				<view class="label common_title">服务日期</view>
				<input type="text" v-model="form.date" class="input" placeholder="请选择服务日期"
					:placeholder-style="placeholder" :disabled="disabled" />
			</view>
			<view class="serve_patient item" @click="picker.time = true">
				<view class="label common_title">服务时间</view>
				<input type="text" v-model="form.timeSlot" class="input" placeholder="请选择服务时间段"
					:placeholder-style="placeholder" :disabled="disabled" />
			</view>
		</view>
		...
		<view class="remark">
			...
			<u-input class="textarea" v-model="form.remark" type="textarea" placeholder="如需备注，请说明情况……"
				maxlength="100" />
		...
		<view class="bottom_message">
			...
			<view class="content">
				<view v-for="item in 6" :key="this">1.预约上门</view>
			</view>
			...
			<image src="http://xiaohulaile.com/wxcx/tuikuan/tuikuan.png" :lazy-load="true"
				style="width:662rpx;height:602rpx;margin-left:18rpx"></image>
		</view>
		...
		<view class="bottom_payBar">
			...
			<view class="flex">
				<view class="detail" @click="orderDetailPop = !orderDetailPop">
					...
					<image src="../../../static/index/up.png" mode="widthFix" v-show="orderDetailPop == false"
						class="arrow_icon" :lazy-load="true"></image>
					<image src="../../../static/index/down.png" mode="widthFix" v-show="orderDetailPop"
						class="arrow_icon" :lazy-load="true"></image>
				</view>
		...
		<u-popup mode="center" v-model="orderPop" class="orderPop" border-radius="24">
			<view class="content">
				<view class="top">
					<image src="../../../static/index/orderPopTop.png" class="poptop" mode="widthFix" :lazy-load="true">
					</image>
				...
				<view class="bottom_tools">
					...
					<view class="btns">
						<u-button type="primary" class="cancel btn" :ripple="true" @click="orderPop = false">取消
						</u-button>
