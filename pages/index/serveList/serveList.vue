    ...
    <view class="container">
        ...
        <view class="list">
            ...
            <view class="list_3" v-for="item in zkserveList" :key="item.id" @click="goOrder(item.id)">
                <view class="list_3_1"><image :src="item.serviceMap" mode="widthFix"></image></view>
                <view class="list_3_2">
                    <view>{{ item.serviceName }}</view>
                    <view>
                        <view>
                            <image src="../../../static/index/xingxing.png" mode="" v-for="count in 4" :key="this"></image>
