<template>
    <view class="container">
        ...
        <view class="main">
                ...
                <view class="item">
                    ...
                    <view class="wrap">
                        <u-form-item :border-bottom="false" class="form_item" style="width:260rpx;" prop="authcode">
                            ...
                            <u-input v-model="form.authcode" class="input" :height="inputheight" placeholder="验证码" :placeholder-style="inputplaceholder" maxlength="4" />
                        </u-form-item>
            ...
            <!-- 用户协议 -->
            <view class="YH_login" @click="toUserArgument">
                <text>
                    点击 “登录” 即表示您同意
                    <text class="Text_1">《上海小护来了用户协议》、《服务条款》,</text>
